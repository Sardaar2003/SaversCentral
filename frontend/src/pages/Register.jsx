...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) {
      addToast('success', 'Account Created', 'Registration was successful.');
      navigate('/');
    } else {
      setError(result.message);
      addToast('error', 'Registration Failed', result.message);
    ...
    <div style={wrapperStyle}>
      ...
      <div className="glass-panel" style={cardStyle}>
        <div style={headerStyle}>
          ...
          <p style={subtitleStyle}>Create your sales portal account</p>
        </div>
